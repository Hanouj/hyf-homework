...
function Main(){
    ...
    const buttonAddClick =(e)=>{
        ...
        if (!deadline || !description){alert("Add both description and deadline!")} else{
 setTodos([...todos, {
          id: Date.now(),
...
<div>
    ...
    <input onChange={(e)=>{console.log(e.target.value); setDeadline(e.target.value) }}
value={deadline} type="date"/>
</div>
<br/>
           <button className="btn-add" onClick={buttonAddClick}>Add todo</button>
